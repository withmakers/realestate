...
# read data
data = fread(file.path(PATH_INPUT,"TRDB_상환완료.csv"),fill=T)
head(data)
...
# 지역2
data[,지역2:=mapply("[[",strsplit(x1,split = " "),3)]
...
# save 
data[,TARGET:="상환완료"]
write.csv(data,file.path(PATH_OUTPUT,"102_TERA100.csv"),row.names = F)
